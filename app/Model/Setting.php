...
class Setting extends Model { 
	...
	public static function selectOnefieldDatasForVisa($fieldArray,$orderid,$request) {
	...
	public static function Orderidgenerateforthreetext($tbl_name) {
	...
	public static function Orderidgeneratetext($tbl_name) {
	...
	public static function getsalaryDetailsCount($flg,$tbl_name) {
		$db = DB::connection('mysql');
		$query = $db->table($tbl_name)
	...
	public static function insertqueryforbank($tbl_name,$request) { 
		...
		if ($tbl_name == 'mstsalary' || $tbl_name == 'mstsalaryplus') {
			$salaryid = $getTableFields[$tbl_name]['insertfields'][7];
			$maxid=self::getsalaryDetailsCount($request->location,$tbl_name);
			if($maxid == "") {
	...
	public static function insertqueryforsalary($tbl_name,$request) {
		$db = DB::connection('mysql');
		...
		$Name = $getTableFields[$tbl_name]['insertfields'][1];

		$nick_name = $getTableFields[$tbl_name]['insertfields'][2];
		...
		if ($tbl_name == 'mstsalary' || $tbl_name == 'mstsalaryplus') {
			$salaryid = $getTableFields[$tbl_name]['insertfields'][8];
			$maxid=self::getsalaryDetailsCount($request->location,$tbl_name);
			if($maxid == "") {
				if ($request->location == '1') {
					$cus3 = "SD001";
			...
			$sql=$db->table($tbl_name)->insert(
				...
				$Name => $request->textbox1,

				$nick_name => $request->textbox2,
	...
	public static function insertqueryforbranch($tbl_name,$request) { 
		...
		$DBType3 = $getTableFields[$tbl_name]['insertfields'][2];
	...
	public static function insertqueryonefield($tbl_name,$request,$orderid) {
	...
	public static function updateoneField($request) {
	...
	public static function updatethreeField($request) {
		...
		$textbox1 = $getTableFields[$request->tablename]['updatefields'][0];
		...
		$update = $db->table($request->tablename)
			...
			->update(
				...
				[$textbox1 => $request->textbox1,

				$Typename1 => $request->textbox2,

				$Typename2 => $request->textbox3,
	...
	public static function selectEightfieldDatas($fieldArray,$orderid,$request) {
	...
	public static function getInsertUpdateCompanyDetails($request, $tbl_name) {
