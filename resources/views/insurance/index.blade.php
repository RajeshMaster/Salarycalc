...
{{ HTML::script('resources/assets/js/insurance.js') }}
...
<div class="CMN_display_block" id="main_contents">
	...
	<article id="expenses" class="DEC_flex_wrapper " data-category="staffexpenses totexp_sub_2">
		{{ Form::open(array('name'=>'insuranceIndex', 'id'=>'insuranceIndex', 'url' => 'insurance/index?mainmenu='.$request->mainmenu.'&time='.date('YmdHis'),'files'=>true,
		...
		<div class="row hline pm0">
			...
			<div class="col-xs-12">
				...
				<img class="pull-left box35 mt15" src="{{ URL::asset('resources/assets/images/insurance.png') }}">
	 				...
	 				@for ($i = 0; $i < count($get_emp_det); $i++)
						...
						<tr>
							...
							@php 
								...
								for($k=1; $k<=12; $k++ ){
									if(isset($Amount[$k])){
										echo '<td class="tar">'.number_format($Amount[$k]).'</td>';
									} else {
										echo '<td></td>';
									}
								}
