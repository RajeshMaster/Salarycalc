		...
		{{ Form::open(array('name'=>'addeditsalarycalc', 
			...
			<div class="col-xs-12 pt5">
				...
				<!-- Session msg -->
					<div class="col-xs-6" style="text-align: left;margin-left: -15px;">
						...
						<a href="javascript:fngodownloadempid('{{ $request->mainmenu }}');" class=" btn btn-primary box100"><span class="fa fa-download"></span> {{ trans('messages.lbl_download') }}</a>
					</div>
			</div>
			...
			<div class="col-xs-6">
				...
				style="width: auto !important; background-color: white; border:none !important;float: left; font-size: 15px; position: relative; margin-top: -13px;margin-bottom: 0px !important;margin-left: -5px !important;">
					...
					<div class="col-xs-12 pm0 pull-right mb10 pl20 pr10 mt2 fwb">
										...
										<div class="col-xs-12 mt10 @if($x1 == $len1 - 1) mb10 @endif">
											...
											<div class="col-xs-5">
												<span class="col-xs-6 text-right">
													{{ (isset($arr2[$key3]) && $arr2[$key3] != '') ? number_format($arr2[$key3]): '0' }}
												</span>
			...
			<div style="float: right;" class="col-xs-6">
								...
								@foreach ($ded_arr_name as $key3 => $value3)
									@if($key3 == $value2)
										...
										<div class="col-xs-12 mt10 @if($x2 == $len2 - 1) mb10 @endif">
											...
											<div class="col-xs-5">
												<span class="col-xs-6 text-right">
													{{ (isset($arr4[$key3]) && $arr4[$key3] != '') ? number_format($arr4[$key3]): '0' }}
												</span>
												<span class="pm0 col-xs-2">
													円
												</span>
				...
				<fieldset class="col-xs-12 mt20" style="display: block !important;">
				<legend align="left" 
				style="width: auto !important; background-color: white; border:none !important;float: left; font-size: 15px; position: relative; margin-top: -13px;margin-bottom: 0px !important;margin-left: -5px !important;">
					...
					<div class="col-xs-12" style="margin-top: 0px;">
						<div class="col-xs-12 mt10 mb10">
								<div class="col-xs-7 text-right clr_blue">
									<label>
										{{ trans('messages.lbl_travel_exp') }}
									</label>
								</div>
								<div class="col-xs-5">
									<span class="col-xs-6 text-right">
										@php $val1 += isset($detedit->Travel)?$detedit->Travel:'' @endphp
										{{ !empty($detedit->Travel)?number_format($detedit->Travel):'0' }}
									</span>
