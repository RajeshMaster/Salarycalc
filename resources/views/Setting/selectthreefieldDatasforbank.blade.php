...
{{ Form::hidden('location', $request->location, array('id' => 'location')) }}
    ...
    <fieldset class="h50">
      ...
      <div class="col-md-12 mt10 ml50">
        ...
        <div class="ml15 pull-left box50per mb5">
          ...
          'class' => 'deg box320per widthauto input-sm form-control',

          'style' => 'background-color: white;max-width:99%;',
  ...
  <div class="modal-footer">
    ...
    <div class="bg-info pt10 pb10">

    <center>

    {{--*/ $tablename = "mstbankbranch" /*--}}
      ...
      <div class="box100per text-center">
        ...
        <div class="CMN_display_block" id="add_var">
          ...
          <button  id="btnadd" type="button" 
                  ...
                  onclick="return fnaddeditthreefieldforbank('{{ $request->location }}',

                           '{{ $request->mainmenu }}','{{ $tablename }}','{{ 1 }}');" 
        ...
        <div class="CMN_display_block" id="update_var"  style="display: none;">
                    ...
                    <button  id="btnadd" type="button" 
                        ...
                        onclick="return fnaddeditthreefieldforbank('{{ $request->location  }}','{{ $request->mainmenu }}','{{ $tablename }}','{{ 2 }}');" 
