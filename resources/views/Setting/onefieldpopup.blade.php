...
{{ Form::hidden('flag', '', array('id' => 'flag')) }}
  ...
  <div class="box98per">
    ...
    <div align="center" class="alertboxalign" id="popupsessionfail" style="display: none;">

      <p class="alert alert-danger">

        Used ID Can't be Update
    ...
    <button id="edit" data-dismiss="modal" onclick="return fneditcheckonefield();" 
  ...
  <div class="box96per ml15">
    ...
    <fieldset class="h50">
      ...
      <div class="col-md-12 mt10 ml50 pb3">
      ...
      <div class="box100per text-center">
        ...
        <div class="CMN_display_block" id="add_var">
          ...
          <button  id="btnadd" type="button" 
                  ...
                  onclick="return fnaddeditonefield('{{ $request->location  }}','{{ $request->mainmenu }}','{{ $request->tablename }}','{{ 1 }}');" 
        ...
        <div class="CMN_display_block" id="update_var"  style="display: none;">
          ...
          <button id="btnadd" type="button" 
                  ...
                  onclick="return fnaddeditonefield('{{ $request->location  }}','{{ $request->mainmenu }}','{{ $request->tablename }}','{{ 2 }}');" 
