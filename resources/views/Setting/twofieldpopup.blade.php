...
{{ Form::hidden('flag', '', array('id' => 'flag')) }}
  ...
  <div class="box98per">
    ...
    <button id="edit" data-dismiss="modal" onclick="return fneditchecktwofield();" 
  ...
  <div class="table_Scroll_limit_set ml11 CMN_display_block box96per bdg ml15" 
      ...
      <tbody class="box100per h35">
        ...
        @forelse($query as $count => $data)
          ...
          <tr class="h37">
            ...
            <td class="text-center">
              ...
              <input type="radio" name="rdoedit" id="rdoedit{{ $data->$selectfiled['0'] }}"
                     ...
                     class="h13 w13"  onclick="fnrdochecktwofield(
                                               ...
                                               '{{ $data->$selectfiled['1'] }}','{{ $data->$selectfiled['2'] }}','{{ $data->$selectfiled['0'] }}');">
            ...
            <td class="pl5 pt7" id="dataname1{{$data->$selectfiled['0']}}">{{ $data->$selectfiled['1'] }}</td>

            <td class="pl5 pt7" id="dataname2{{$data->$selectfiled['0']}}">{{ $data->$selectfiled['2'] }}</td>

            <td class="pt7 tac" title="Use/Not Use">
              ...
              <a id="usenotuseanchor{{$i}}" href="javascript:useNotuse('{{ $data->$selectfiled['0'] }}',
                ...
                <span class="btn-link" id="usenotuselabel{{$i}}" data-type="{{ $data->$selectfiled['4'] }}" style="color:blue;cursor: pointer;">{{ trans('messages.lbl_use') }}

                </span>

                @else 

                <span class="btn-link" id="usenotuselabel{{$i}}" data-type="{{ $data->$selectfiled['4'] }}" style="color:red;cursor: pointer;">{{ trans('messages.lbl_notuse') }}
    ...
    <fieldset class="h50">
      ...
      <div class="col-md-12 mt10 ml50">
        ...
        <div class="ml15 pull-left box70per mb5">
          ...
          'class'=>'box40per form-control ime_mode_disabled','maxlength' => 40,
      ...
      <div class="box100per text-center">
        ...
        <div class="CMN_display_block" id="add_var">
          ...
          <button  id="btnadd" type="button" 
                  ...
                  onclick="return fnaddedittwofield('{{ $request->location  }}','{{ $request->mainmenu }}','{{ $request->tablename }}','{{ 1 }}');" 
        ...
        <div class="CMN_display_block" id="update_var"  style="display: none;">
          ...
          <button id="btnadd" type="button" 
                  ...
                  onclick="return fnaddedittwofield('{{ $request->location  }}','{{ $request->mainmenu }}','{{ $request->tablename }}','{{ 2 }}');" 
