                            ...
                            <tr>
                                <td colspan="2" bgcolor="#FFFFFF">
                                    <table style="font-family:Calibri;text-align:left;padding:10px 5px 0;line-height:18px;font-size:14px;width: 100%;">
                                        ...
                                        <tr>
                                            <td colspan="2" style="width: 15%;">Dear {{ strtoupper($salaryDetails['LastName']) }}</td>
                                        </tr>
                                        <tr></tr>
                                        <tr></tr>
                                        <tr></tr>
                                        ...
                                        @php $val1 += $salaryDetails['Basic'] @endphp
                                        <tr>
                                            <td style="width: 35%;color:#5a5a5a;" bgcolor="#FFFFFF">Basic</td>
                                            <td style="color:#5a5a5a;">
                                                {{ number_format($salaryDetails['Basic']) }}
                                            </td>
                                        </tr>
                                        @endif
                                        @if($salaryDetails['hra'] != '')
                                        @php $val1 += $salaryDetails['hra'] @endphp
                                        <tr>
                                            <td style="width: 35%;color:#5a5a5a;" bgcolor="#FFFFFF">HRA (House) </td>
                                            <td style="color:#5a5a5a;">
                                                {{ number_format($salaryDetails['hra']) }}
                                            </td>
                                        </tr>
                                        @endif
                                        @if($salaryDetails['train_daily'] != '')
                                        @php $val1 += $salaryDetails['train_daily'] @endphp
                                        <tr>
                                            <td style="width: 35%;color:#5a5a5a;" bgcolor="#FFFFFF">Train Daily</td>
                                            <td style="color:#5a5a5a;">
                                                {{ number_format($salaryDetails['train_daily']) }}
                                            </td>
                                        </tr>
                                        @endif
                                        @if($salaryDetails['others'] != '')
                                        @php $val1 += $salaryDetails['others'] @endphp
                                        <tr>
                                            <td style="width: 35%;color:#5a5a5a;" bgcolor="#FFFFFF">Others</td>
                                            <td style="color:#5a5a5a;">
                                                {{ number_format($salaryDetails['others']) }}
                                            </td>
                                        </tr>
                                        @endif
                                        @php
                                                ...
                                                <tr>
                                                    @for ($e=0; $e < count($salary_det); $e++)
                                                        @if ($key2 == $salary_det[$e]->Salarayid)
                                                            <td style="width: 35%;color:#5a5a5a;" bgcolor="#FFFFFF">{{ $salary_det[$e]->Name }}</td>
                                                        @endif
                                                    @endfor
                                        ...
                                        <tr>
                                            <td style="width: 35%;color:#5a5a5a;" bgcolor="#FFFFFF">Total</td>
                                                ...
                                                <tr>
                                                    @for ($e=0; $e < count($salary_ded); $e++)
                                                        @if ($key3 == $salary_ded[$e]->Salarayid)
                                                            <td style="width: 35%;color:#5a5a5a;" bgcolor="#FFFFFF">{{ $salary_ded[$e]->Name }}</td>
                                                        @endif
                                                    @endfor
                                        ...
                                        <tr>
                                            <td style="width: 35%;color:#5a5a5a;" bgcolor="#FFFFFF">G. Total</td>
                                            <td style="color:#5a5a5a;">
                                                @php
                                                    $gtotal = 0;
                                                    $gtotal = $val1 + $val2;
                                        ...
                                        ?>
                                        <tr>
                                            <td style="width: 35%;color:#5a5a5a;" bgcolor="#FFFFFF">Transferred</td>
                                            <td style="color:#5a5a5a;">{{ number_format($salaryDetails['Transferred']) }}</td>
                                        </tr>
                                        
                                        
                                        <tr>
                                            <td style="width: 35%;color:#5a5a5a;" bgcolor="#FFFFFF">Balance</td>
                                            @php 
                                                $tot = '';
                                                $tot = $salaryDetails['Transferred'] - $gtotal;
                                            @endphp
                                        ...
                                        <tr>
                                            ...
                                            <td style="color:#5a5a5a;">{!! nl2br(e((!empty($salaryDetails['remarks']) ? $salaryDetails['remarks'] : ""))) !!}</td>
                                        </tr>
                                        <?php 
                                            for ($i=0; $i < 15; $i++) { 
                                                echo "<tr></tr>";
