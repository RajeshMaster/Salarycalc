...
<article id="master" class="DEC_flex_wrapper " data-category="master master_sub_1">
	...
	{{ Form::open(array('name'=>'passwordchangecancel','id'=>'passwordchangecancel', 'url' => 'User/passwordchangeprocess?mainmenu='.$request->mainmenu.'&time='.date('YmdHis'),'files'=>true,'method' => 'POST')) }}
		{{ Form::hidden('mainmenu', $request->mainmenu , array('id' => 'mainmenu')) }}
		{{ Form::hidden('viewid', $request->id , array('id' => 'viewid')) }}
	{{ Form::close() }}
</article>
