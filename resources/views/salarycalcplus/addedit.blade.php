...
<div class="CMN_display_block" id="main_contents">
	...
	<article id="expenses" class="DEC_flex_wrapper " data-category="expenses expenses_sub_3">
		@if(isset($detedit))
		    {{ Form::model($detedit, ['name'=>'addeditsalarycalc', 
									...
									'url' => 'salarycalcplus/addeditprocess?mainmenu='.$request->mainmenu.'&time='.date('YmdHis'),
									'files' => true,
									'method' => 'POST']) }}
					...
					<div class="col-xs-12" style="margin-top: 0px;">
						...
						<div class="col-xs-12 mt10 mb10">
							...
							<div class="col-xs-7">
								...
								<!-- <a id="getsal_amt" onclick="javascript:gototsalamount();" class="btn btn-primary box140 white ml5" style="padding: 3px 3px;">{{trans('messages.lbl_sal_amt')}}
								</a> -->
	    ...
	    {{ Form::close() }}
	    {{ Form::open(array('name'=>'salaryplusaddeditcancel', 'id'=>'salaryplusaddeditcancel', 'url' => 'salarycalcplus/index?mainmenu='.$request->mainmenu.'&time='.date('YmdHis'),'files'=>true,'method' => 'POST')) }} 
    ...
    'url' => 'salarycalcplus/view?mainmenu='.$request->mainmenu.'&time='.date('YmdHis'),
